...
namespace WebDAVServer.NetCore.FileSystem
{
    ...
    {
        /// <summary>
        /// Corresponding folder in the file system.
        /// </summary>
        ...
        {
            // TODO: implement root deletion check.
            /*
            ...
            */
            ...
            var childs = await GetChildrenAsync(new PropertyName[0]);
            foreach (IHierarchyItemAsync child in childs)
            {
                try
                {
        ...
        public async Task<long> GetAvailableBytesAsync()
        {
            ...
            return new DriveInfo(dirInfo.FullName).AvailableFreeSpace;
        }
        ...
        public async Task<long> GetUsedBytesAsync()
        {
            ...
            DriveInfo driveInfo = new DriveInfo(dirInfo.FullName);
        ...
        {
            // Not implemented in .NET Core version.
            // See the full .NET Framework file system sample for example of implementation.
        ...
        /// <returns>Returns <c>true</c> if <paramref name="destFolder"/> is inside thid folder, <c>false</c> otherwise.</returns>
