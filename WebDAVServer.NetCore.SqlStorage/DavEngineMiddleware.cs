...
namespace WebDAVServer.NetCore.SqlStorage
{
    ...
    public class DavEngineMiddleware
    {
        ...
        /// </summary>
        private readonly DavEngineCore engineCore;
        ...
        {
            await engineCore.RunAsync(davContext);
        }
    }
    ...
    public static class DavEngineMiddlewareExtensions
    {
        ...
        public static void AddWebDav(this IServiceCollection services, IConfigurationRoot configuration, IHostingEnvironment env)
        {
            ...
            services.AddSingleton<ILogger, DefaultLoggerCoreImpl>();
            ...
            services.Configure<DavContextOptions>(async options => await Configuration.GetSection("DavContextOptions").ReadOptionsAsync(options));
