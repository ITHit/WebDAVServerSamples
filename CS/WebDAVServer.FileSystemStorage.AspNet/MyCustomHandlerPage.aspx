...
-                              uploading with pause/resume and auto-restore upload.
                ...
                <div class="ithit-grid-toolbar row">
                    ...
                    <div class="col-auto px-2">
                        <label class="btn-upload-items"
                            title="Upload Items"
                            for="ithit-button-input">
                            <span class="d-none d-xl-inline">Upload</span></label>
                    ...
                    <div class="third-section col-auto px-0 px-md-1">
                        <!-- Toolbar buttons here -->
                    </div>
                    <div class="fourth-section col-auto px-1 px-lg-3">
                        <!-- Toolbar buttons here -->
                    </div>
                    <div class="fifth-section col-auto px-1 pr-lg-3 pl-lg-1">
                        <!-- Toolbar buttons here -->
                    </div>
                </div>
                <div class="ithit-grid-uploads d-none">
                    ...
                    <div class="uploading-block">
                        <div class="uploading-controls">
                            ...
                            <button class="pause-button pause-all-button float-right" title="Pause"></button>
                            <button class="play-button play-all-button float-right" title="Resume"></button>
                        </div>
                        <div>
                    ...
                    <div class="uploading-details d-none">
                        ...
                        <div class="text-right">
                            <button class="pause-all-button btn btn-outline-primary" title="Pause all">Pause upload</button>
                            <button class="play-all-button btn btn-outline-primary" title="Resume all">Resume upload</button>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <ol>
                                                <li>Download and install the file below:<br />
                                                    ...
                                                    <p class="more-pnl">
                                                        <span class="window">Windows:&nbsp;&nbsp;<a target="_blank" href="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/node_modules/webdav.client/Plugins/ITHitEditDocumentOpener.msi">ITHitEditDocumentOpener.msi</a><br />
                                                        </span>
                                                        <span class="linux">Linux:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/node_modules/webdav.client/Plugins/ITHitEditDocumentOpener.deb">ITHitEditDocumentOpener.deb</a><br />
                                                        </span>
                                                        <span class="mac-os">Mac OS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/node_modules/webdav.client/Plugins/ITHitEditDocumentOpener.pkg">ITHitEditDocumentOpener.pkg</a><br />
                                                        </span>
                                                    </p>
                                                </li>
    ...
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-basebutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-deletebutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-copypastecutbuttons.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-printbutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-reloadbutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-renamebutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-createfolderbutton.js"></script>
    <script src="<%=Request.ApplicationPath.TrimEnd('/')%>/wwwroot/js/toolbar/webdav-toolbar.js"></script>
