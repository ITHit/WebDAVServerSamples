        ...
        **/
        ...
        _RenderContextMenu: function (oItem, $btnGroup, isMicrosoftOfficeDocument, isGSuiteDocument, isDavProtocolSupported, isExclusiveLocked) {
            ...
            if (isGSuiteDocument) {
                ...
                $('<a class="dropdown-item ' + (displayRadioBtns ? 'dropdown-radio' : '') + (supportGSuiteFeature && !isExclusiveLocked ? '' : ' disabled') + '" href="javascript:void()" title="Edit document in G Suite Editor."><i class="icon-gsuite-edit"></i>Edit with Google G Suite Online</a>')
                    .appendTo($dropdownMenu).on('click', function () {
