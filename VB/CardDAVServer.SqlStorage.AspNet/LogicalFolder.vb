...
Public Class LogicalFolder
    ...
    Private children As IEnumerable(Of IHierarchyItemAsync)
    ...
    Public Sub New(context As DavContext, path As String, Optional children As IEnumerable(Of IHierarchyItemAsync) = Nothing)
        MyBase.New(context)
        Me.Context = context
        Me.itemPath = path
