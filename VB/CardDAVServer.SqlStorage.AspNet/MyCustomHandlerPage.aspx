...
<%@ Page Async="true" Title="WebDAV" Language="C#" AutoEventWireup="true" Inherits="CardDAVServer.SqlStorage.AspNet.MyCustomHandlerPage" %>

<%@ Import Namespace="CardDAVServer.SqlStorage.AspNet" %>
<!DOCTYPE html>
<html lang="en">
<head>
